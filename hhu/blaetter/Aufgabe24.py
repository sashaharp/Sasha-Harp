...
# -*- coding: utf-8 -*-
"""
Created on Wed Nov 28 13:43:07 2018

@author: sashaharp

based on Polynom funciton by mfischer
"""
import numpy as np
...
class Polynom():
    ...
    def plot(self, fignum=None, xmin=0, xmax=1, num=50, style=None):
        x = np.linspace(xmin, xmax, num)
        y = np.array([sum([a*xn**b for a, b in self.dp.items()]) for xn in x])
